...
<head>
    ...
    <style>
        ...
        .btn-save { background-color: #ffab00; color: white; border: none; border-radius: 8px; padding: 10px 25px; font-weight: 500; }
        .btn-save:hover { background-color: #e09600; color: white; }
        ...
        <div class="admin-card">
            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-save"><i class="bi bi-arrow-clockwise"></i> Cập nhật</button>
